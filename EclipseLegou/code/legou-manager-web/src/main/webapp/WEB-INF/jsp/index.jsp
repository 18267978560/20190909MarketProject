...
<body class="easyui-layout">
    <!-- 头部标题 -->
	<div data-options="region:'north',border:false" style="height:80px; padding:10px; background:#F3F3F3"> 
		<span class="northTitle">乐购网后台管理系统</span>
    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	...
         	<li>
         		<span>索引库管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'index-item'}">创建solr索引</li>
	         	</ul>
         	</li>
         </ul>
    </div>
